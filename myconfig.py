...
THROTTLE_FORWARD_PWM = 460   #could be higher just cautious   #500      #pwm value for max forward throttle
THROTTLE_STOPPED_PWM = 370      #pwm value for no movement
THROTTLE_REVERSE_PWM = 260 #could be lower      #pwm value for max reverse throttle
# 
...
# 
# #SOMBRERO
HAVE_SOMBRERO = True           #set to true when using the sombrero hat from the Donkeycar store. This will enable pwm on the hat.
# 
# #ROBOHAT MM1
